...
def handle_global_exception(error):
    """Global exception handler that logs stacktrace but returns sanitized response"""
    import traceback
...
@security_manager.limiter.limit("10 per minute")  # Rate limit login attempts as specified
def login():
...
@jwt_required()
@security_manager.limiter.limit("5 per minute")  # Rate limit diet plan generation as specified
...
def openapi_spec():
    ...
    spec = {
        ...
        "info": {
            ...
            "description": "A comprehensive diet planning API with AI-powered meal recommendations",
            "version": "1.0.0",
            "contact": {
                "name": "Diet Planner Team",
                "email": "support@dietplanner.com"
            },
            "license": {
                "name": "MIT",
        ...
        "servers": [
            ...
            {
                "url": "https://api.dietplanner.com/api",
        ...
        "paths": {
            ...
            "/login": {
                "post": {
                    "summary": "User login",
                    "description": "Authenticate user (Rate limit: 10/min)",
                    "responses": {
            ...
            "/diet-plan": {
                "post": {
                    ...
                    "description": "Generate AI-powered diet plan (Rate limit: 5/min)",
                    "security": [{"bearerAuth": []}],
                    "responses": {
                        "201": {"description": "Diet plan generated"},
